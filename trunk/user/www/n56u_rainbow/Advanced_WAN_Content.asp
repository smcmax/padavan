...
<body onload="initial();" onunLoad="return unload_body();">
	...
	<div class="wrapper">
		...
		<form method="post" name="form" id="ruleForm" action="/start_apply.htm" target="hidden_frame">
			...
			<input type="hidden" name="sid_list"
				value="Layer3Forwarding;LANHostConfig;IPConnection;PPPConnection;WLANConfig11b">
			...
			<input type="hidden" name="pppoemwan_staticnum_x_0" value="<% nvram_get_x(" ppoemwanIPList ", "
				pppoemwan_staticnum_x "); %>" readonly="1" />
										...
										<div class="row-fluid">
											...
											<table width="100%" align="center" cellpadding="4" cellspacing="0"
												...
												<tr>
													...
													<td align="left">
														<select class="input" name="wan_proto"
															onchange="change_wan_type(this.value);fixed_change_wan_type(this.value);">
															<option value="static" <% nvram_match_x( "" , "wan_proto"
																, "static" , "selected" ); %>
																>IPoE:
																<#BOP_ctype_title5#>
															</option>
															<option value="dhcp" <% nvram_match_x( "" , "wan_proto"
																, "dhcp" , "selected" ); %>
																>IPoE:
																<#BOP_ctype_title1#>
															</option>
															<option value="pppoe" <% nvram_match_x( "" , "wan_proto"
																, "pppoe" , "selected" ); %>
																>PPPoE
															</option>
															<option value="pptp" <% nvram_match_x( "" , "wan_proto"
																, "pptp" , "selected" ); %>
																>PPTP
															</option>
															<option value="l2tp" <% nvram_match_x( "" , "wan_proto"
																, "l2tp" , "selected" ); %>
																>L2TP
															</option>
														</select>
												...
												<tr id="row_pppoe_dhcp" style="display:none;">
													...
													<td>
														<select name="wan_pppoe_man" class="input"
															onchange="change_pppoe_man(this.value);">
															<option value="0" <% nvram_match_x( "" , "wan_pppoe_man"
																, "0" , "selected" ); %>
																>
																<#checkbox_No#>
															</option>
															<option value="1" <% nvram_match_x( "" , "wan_pppoe_man"
																, "1" , "selected" ); %>
																>DHCP or Static
															</option>
															<option value="2" <% nvram_match_x( "" , "wan_pppoe_man"
																, "2" , "selected" ); %>
																>ZeroConf (169.254.*.*)
															</option>
														</select>
												...
												<tr id="row_hwnat">
													<th>
														<a class="help_tooltip" href="javascript:void(0);"
															onmouseover="openTooltip(this,7,23);">
															<#HardwareNAT#>
														</a>
													</th>
													<td>
														<select name="hw_nat_mode" class="input">
															<option value="0" <% nvram_match_x( "" , "hw_nat_mode" , "0"
																, "selected" ); %>
																>Disable (Slow)
															</option>
															<option value="1" <% nvram_match_x( "" , "hw_nat_mode" , "1"
																, "selected" ); %>
																>Offload TCP/UDP for LAN/WLAN
															</option>
															<option value="2" <% nvram_match_x( "" , "hw_nat_mode" , "2"
																, "selected" ); %>
												...
												<tr id="row_sfe" style="display:none;">
													...
													<td>
														<select name="sfe_enable" class="input">
															<option value="0" <% nvram_match_x( "" , "sfe_enable" , "0"
																, "selected" ); %>
																>Disable
															</option>
															<option value="1" <% nvram_match_x( "" , "sfe_enable" , "1"
																, "selected" ); %>
																>Enable for IPv4/IPv6
															</option>
															<option value="2" <% nvram_match_x( "" , "sfe_enable" , "2"
																, "selected" ); %>
												...
												<tr id="row_wan_poller">
													...
													<td>
														<input type="checkbox" id="gw_arp_ping_fake" <%
															nvram_match_x( "" , "gw_arp_ping" , "1" , "value=1 checked"
															); %>
														<% nvram_match_x( "" , "gw_arp_ping" , "0" , "value=0" ); %>
															>
															<div style="position: absolute; margin-left: -10000px;">
																<input type="radio" name="gw_arp_ping"
																	id="gw_arp_ping_1" value="1" <% nvram_match_x( ""
																	, "gw_arp_ping" , "1" , "checked" ); %>
																/>
																<#checkbox_Yes#>
																	<input type="radio" name="gw_arp_ping"
																		id="gw_arp_ping_0" value="0" <%
																		nvram_match_x( "" , "gw_arp_ping" , "0"
																		, "checked" ); %>
																	/>
																	<#checkbox_No#>
															</div>
											...
											<table width="100%" align="center" cellpadding="4" cellspacing="0"
												class="table" id="tbl_dhcp_sect">
												<tr>
													<th id="dhcp_sect_desc" colspan="2"
												...
												<tr id="row_dhcp_toggle">
													...
													<td>
														<input type="checkbox" id="x_DHCPClient_fake" <%
															nvram_match_x( "" , "x_DHCPClient" , "1" , "value=1 checked"
															); %>
														<% nvram_match_x( "" , "x_DHCPClient" , "0" , "value=0" ); %>
															>
															<div style="position: absolute; margin-left: -10000px;">
																<input type="radio" name="x_DHCPClient"
																	id="x_DHCPClient_1" class="input" value="1"
																	onclick="set_wan_dhcp_auto(1);" <% nvram_match_x( ""
																	, "x_DHCPClient" , "1" , "checked" ); %>
																/>
																<#checkbox_Yes#>
																	<input type="radio" name="x_DHCPClient"
																		id="x_DHCPClient_0" class="input" value="0"
																		onclick="set_wan_dhcp_auto(0);" <%
																		nvram_match_x( "" , "x_DHCPClient" , "0"
																		, "checked" ); %>
																	/>
																	<#checkbox_No#>
															</div>
												...
												<tr id="row_wan_ipaddr">
													<th width="50%">
														<a class="help_tooltip" href="javascript:void(0);"
															onmouseover="openTooltip(this,7,1);">
															<#IPConnection_ExternalIPAddress_itemname#>
														</a>
													</th>
													<td>
														<input type="text" name="wan_ipaddr" maxlength="15"
															class="input" size="15" value="<% nvram_get_x(" ","
															wan_ipaddr "); %>"
												...
												<tr id="row_wan_netmask">
													<th>
														<a class="help_tooltip" href="javascript:void(0);"
															onmouseover="openTooltip(this,7,2);">
															<#IPConnection_x_ExternalSubnetMask_itemname#>
														</a>
													</th>
													<td>
														<input type="text" name="wan_netmask" maxlength="15"
															class="input" size="15" value="<% nvram_get_x(" ","
															wan_netmask "); %>"
															onKeyPress="return is_ipaddr(this,event);" />
													</td>
												...
												<tr id="row_wan_gateway">
													<th>
														<a class="help_tooltip" href="javascript:void(0);"
															onmouseover="openTooltip(this,7,3);">
															<#IPConnection_x_ExternalGateway_itemname#>
														</a>
													</th>
													<td>
														<input type="text" name="wan_gateway" maxlength="15"
															class="input" size="15" value="<% nvram_get_x(" ","
															wan_gateway "); %>"
															onKeyPress="return is_ipaddr(this,event);" />
													</td>
												...
												<tr id="row_wan_mtu">
													...
													<td>
														<input type="text" name="wan_mtu" maxlength="4" class="input"
															size="5" value="<% nvram_get_x(" "," wan_mtu "); %>"
											...
											<table width="100%" align="center" cellpadding="4" cellspacing="0"
												...
												<tr id="row_dns_toggle">
													<th width="50%">
														<a class="help_tooltip" href="javascript:void(0);"
															onmouseover="openTooltip(this,7,12);">
															<#IPConnection_x_DNSServerEnable_itemname#>
														</a>
													</th>
													<td>
														<input type="checkbox" id="wan_dnsenable_x_fake" <%
															nvram_match_x( "" , "wan_dnsenable_x" , "1"
															, "value=1 checked" ); %>
														<% nvram_match_x( "" , "wan_dnsenable_x" , "0" , "value=0" ); %>
															>
															<div style="position: absolute; margin-left: -10000px;">
																<input type="radio" name="wan_dnsenable_x"
																	id="wan_dnsenable_x_1" value="1"
																	onclick="set_wan_dns_auto(1);" <% nvram_match_x( ""
																	, "wan_dnsenable_x" , "1" , "checked" ); %>
																/>
																<#checkbox_Yes#>
																	<input type="radio" name="wan_dnsenable_x"
																		id="wan_dnsenable_x_0" value="0"
																		onclick="set_wan_dns_auto(0);" <%
																		nvram_match_x( "" , "wan_dnsenable_x" , "0"
																		, "checked" ); %>
																	/>
																	<#checkbox_No#>
															</div>
												...
												<tr id="row_wan_dns1">
													<th width="50%">
														<a class="help_tooltip" href="javascript:void(0);"
															onmouseover="openTooltip(this,7,13);">
															<#IPConnection_x_DNSServer1_itemname#>
																1:
														</a>
													</th>
													<td>
														<input type="text" maxlength="15" class="input" size="15"
															name="wan_dns1_x" value="<% nvram_get_x(" ","
															wan_dns1_x "); %>"
															onkeypress="return is_ipaddr(this,event);" />
													</td>
												</tr>
												<tr id="row_wan_dns2">
													<th>
														<a class="help_tooltip" href="javascript:void(0);"
															onmouseover="openTooltip(this,7,14);">
															<#IPConnection_x_DNSServer1_itemname#>
																2:
														</a>
													</th>
													<td>
														<input type="text" maxlength="15" class="input" size="15"
															name="wan_dns2_x" value="<% nvram_get_x(" ","
															wan_dns2_x "); %>"
															onkeypress="return is_ipaddr(this,event);" />
													</td>
												</tr>
												<tr id="row_wan_dns3">
													<th>
														<a class="help_tooltip" href="javascript:void(0);"
															onmouseover="openTooltip(this,7,15);">
															<#IPConnection_x_DNSServer1_itemname#>
																3:
														</a>
													</th>
													<td>
														<input type="text" maxlength="15" class="input" size="15"
															name="wan_dns3_x" value="<% nvram_get_x(" ","
															wan_dns3_x "); %>"
															onkeypress="return is_ipaddr(this,event);" />
													</td>
												</tr>
											...
											<table width="100%" align="center" cellpadding="4" cellspacing="0"
												class="table" id="tbl_vpn_control">
												<tr>
													<th colspan="2" style="background-color: #E3E3E3;">
												...
												<tr id="row_l2tp_cli" style="display:none">
													...
													<td>
														<select name="wan_l2tpd" class="input">
															<option value="0" <% nvram_match_x( "" , "wan_l2tpd" , "0"
																, "selected" ); %>
																>xL2TPD
															</option>
															<option value="1" <% nvram_match_x( "" , "wan_l2tpd" , "1"
																, "selected" ); %>
																>RP-L2TP
															</option>
														</select>
												...
												<tr id="row_ppp_peer">
													<th width="50%">
														<a class="help_tooltip" href="javascript:void(0);"
															onmouseover="openTooltip(this,7,20);">
															<#PPPConnection_x_HeartBeat_itemname#>
														</a>
													</th>
													<td>
														<input type="text" name="wan_ppp_peer" class="input"
															maxlength="256" size="32" value="<% nvram_get_x(" ","
															wan_ppp_peer "); %>"
												...
												<tr id="pppoemwan4">
													...
													<td style="border-top: 0 none;">
														<input type="checkbox" id="pppoemwan_enable_fake" <%
															nvram_match_x( "" , "pppoemwan_enable" , "1"
															, "value=1 checked" ); %>
														<% nvram_match_x( "" , "pppoemwan_enable" , "0" , "value=0" );
															%>
															/>
															<div style="position: absolute; margin-left: -10000px;">
																<input type="radio" value="1" name="pppoemwan_enable"
																	id="pppoemwan_enable_1" class="input"
																	onclick="change_pppoemwan_enabled()" value="1" <%
																	nvram_match_x( "" , "pppoemwan_enable" , "1"
																	, "checked" ); %>
																/>
																<#checkbox_Yes#>
																	<input type="radio" value="0"
																		name="pppoemwan_enable" id="pppoemwan_enable_0"
																		class="input"
																		onclick="change_pppoemwan_enabled()" value="0"
																		<% nvram_match_x( "" , "pppoemwan_enable" , "0"
																		, "checked" ); %>
																	/>
																	<#checkbox_No#>
															</div>
												...
												<tr id="pppoemwan3">
													...
													<td style="border-top: 0 none;">
														<input type="checkbox" id="pppoesync_enable_fake" <%
															nvram_match_x( "" , "pppoesync_enable" , "1"
															, "value=1 checked" ); %>
														<% nvram_match_x( "" , "pppoesync_enable" , "0" , "value=0" );
															%>
															/>
															<div style="position: absolute; margin-left: -10000px;">
																<input type="radio" value="1" name="pppoesync_enable"
																	id="pppoesync_enable_1" class="input" value="1" <%
																	nvram_match_x( "" , "pppoesync_enable" , "1"
																	, "checked" ); %>
																/>
																<#checkbox_Yes#>
																	<input type="radio" value="0"
																		name="pppoesync_enable" id="pppoesync_enable_0"
																		class="input" value="0" <% nvram_match_x( ""
																		, "pppoesync_enable" , "0" , "checked" ); %>
																	/>
																	<#checkbox_No#>
															</div>
													</td>
												...
												<tr id="pppoemwan2">
													...
													<td>
														<input type="text" class="input" name="pppoe_num" id="pppoe_num"
															style="width: 100px" value="<% nvram_get_x(" ","
															pppoe_num "); %>" />
													</td>
												</tr>
												<tr id="pppoemwan1">
													...
													<td style="border-top: 0 none;">
														<input type="checkbox" id="pppoemwan_rules_x_fake" <%
															nvram_match_x( "" , "pppoemwan_rules_x" , "1"
															, "value=1 checked" ); %>
														<% nvram_match_x( "" , "pppoemwan_rules_x" , "0" , "value=0" );
															%>
															>
															<div style="position: absolute; margin-left: -10000px;">
																<input type="radio" value="1" name="pppoemwan_rules_x"
																	id="pppoemwan_rules_x_1"
																	onclick="change_pppoemwan_rules_enabled()" <%
																	nvram_match_x( "" , "pppoemwan_rules_x" , "1"
																	, "checked" ); %>
																/>
																<#checkbox_Yes#>
																	<input type="radio" value="0"
																		name="pppoemwan_rules_x"
																		id="pppoemwan_rules_x_0"
																		onclick="change_pppoemwan_rules_enabled()" <%
																		nvram_match_x( "" , "pppoemwan_rules_x" , "0"
																		, "checked" ); %>
																	/>
																	<#checkbox_No#>
															</div>
												...
												<tr id="row_static_header" style="display:none">
													<td width="25%">
														...
														<div class="input-append">
															<input type="text" maxlength="12" class="span12" size="12"
																name="pppoemwan_mac_x_0" value="<% nvram_get_x(" ", "
																pppoemwan_mac_x_0 "); %>"
													...
													<td width="25%">
														<input type="text" maxlength="15" class="span12" size="15"
															name="pppoemwan_ip_x_0" value="<% nvram_get_x(" ", "
															pppoemwan_ip_x_0 "); %>"
															onkeypress="return is_ipaddr(this,event);" />
													</td>
													<td width="25%">
														<input type="text" maxlength="24" class="span12" size="20"
															name="pppoemwan_name_x_0" value="<% nvram_get_x(" ", "
															pppoemwan_name_x_0 "); %>"
															onKeyPress="return is_string(this,event);" />
													</td>
													<td width="20%">
														<input type="text" maxlength="24" class="span12" size="20"
															name="pppoemwan_interface_x_0" value="<% nvram_get_x(" ", "
															pppoemwan_interface_x_0 "); %>"
															onKeyPress="return is_string(this,event);" />
													</td>
													<td width="5%">
												...
												<tr id="pppoemwan0">
													...
													<td style="border-top: 0 none;">
														<input type="checkbox" id="pppoemwan_443_fake" <%
															nvram_match_x( "" , "pppoemwan_443" , "1"
															, "value=1 checked" ); %>
														<% nvram_match_x( "" , "pppoemwan_443" , "0" , "value=0" ); %>
															/>
															<div style="position: absolute; margin-left: -10000px;">
																<input type="radio" value="1" name="pppoemwan_443"
																	id="pppoemwan_443_1" class="input" value="1" <%
																	nvram_match_x( "" , "pppoemwan_443" , "1"
																	, "checked" ); %>
																/>
																<#checkbox_Yes#>
																	<input type="radio" value="0" name="pppoemwan_443"
																		id="pppoemwan_443_0" class="input" value="0" <%
																		nvram_match_x( "" , "pppoemwan_443" , "0"
																		, "checked" ); %>
																	/>
																	<#checkbox_No#>
															</div>
												...
												<tr>
													<th width="50%">
														<a class="help_tooltip" href="javascript:void(0);"
															onmouseover="openTooltip(this,7,4);">
															<#PPPConnection_UserName_itemname#>
														</a>
													</th>
													<td>
														<input type="text" maxlength="64" class="input" size="32"
															name="wan_pppoe_username" value="<% nvram_get_x(" ","
															wan_pppoe_username "); %>"
															onkeypress="return is_string(this,event);" />
													</td>
												</tr>
												<tr>
													<th>
														<a class="help_tooltip" href="javascript:void(0);"
															onmouseover="openTooltip(this,7,5);">
															<#PPPConnection_Password_itemname#>
														</a>
													</th>
													<td>
														<div class="input-append">
															<input type="password" maxlength="64" class="input"
																size="32" name="wan_pppoe_passwd" id="wan_pppoe_passwd"
																style="width: 175px;" value="<% nvram_get_x(" ","
																wan_pppoe_passwd "); %>" />
															<button style="margin-left: -5px;" class="btn" type="button"
																onclick="passwordShowHide('wan_pppoe_passwd')">
												...
												<tr>
													...
													<td>
														<select name="wan_ppp_auth" class="input">
															<option value="0" <% nvram_match_x( "" , "wan_ppp_auth"
																, "0" , "selected" ); %>
																>Auto
															</option>
															<option value="1" <% nvram_match_x( "" , "wan_ppp_auth"
																, "1" , "selected" ); %>
																>PAP
															</option>
															<option value="2" <% nvram_match_x( "" , "wan_ppp_auth"
																, "2" , "selected" ); %>
																>CHAP
															</option>
															<option value="3" <% nvram_match_x( "" , "wan_ppp_auth"
																, "3" , "selected" ); %>
																>MS-CHAPv2
															</option>
														</select>
												...
												<tr id="row_ppp_mppe">
													...
													<td>
														<select name="wan_ppp_mppe" class="input">
															<option value="0" <% nvram_match_x( "" , "wan_ppp_mppe"
																, "0" , "selected" ); %>
																>No Encryption
															</option>
															<option value="1" <% nvram_match_x( "" , "wan_ppp_mppe"
																, "1" , "selected" ); %>
																>Auto
															</option>
															<option value="2" <% nvram_match_x( "" , "wan_ppp_mppe"
																, "2" , "selected" ); %>
																>MPPE-40
															</option>
															<option value="3" <% nvram_match_x( "" , "wan_ppp_mppe"
																, "3" , "selected" ); %>
																>MPPE-128
															</option>
														</select>
												...
												<tr id="row_pppoe_mtu">
													<th>
														<a class="help_tooltip" href="javascript:void(0);"
															onmouseover="openTooltip(this,7,7);">
															<#PPPConnection_x_PPPoEMTU_itemname#>
														</a>
													</th>
													<td>
														<input type="text" maxlength="4" size="5" name="wan_pppoe_mtu"
															class="input" value="<% nvram_get_x(" ", "
															wan_pppoe_mtu "); %>"
															onkeypress="return is_number(this,event);" />
														&nbsp;
														<span style="color:#888;">
												...
												<tr id="row_pppoe_mru">
													<th>
														<a class="help_tooltip" href="javascript:void(0);"
															onmouseover="openTooltip(this,7,8);">
															<#PPPConnection_x_PPPoEMRU_itemname#>
														</a>
													</th>
													<td>
														<input type="text" maxlength="4" size="5" name="wan_pppoe_mru"
															class="input" value="<% nvram_get_x(" ", "
															wan_pppoe_mru "); %>"
															onkeypress="return is_number(this,event);" />
														&nbsp;
												...
												<tr id="row_pptp_mtu" style="display:none">
													...
													<td>
														<input type="text" maxlength="4" size="5" name="wan_pptp_mtu"
															class="input" value="<% nvram_get_x(" ", "
															wan_pptp_mtu "); %>"
															onkeypress="return is_number(this,event);" />
														&nbsp;
												...
												<tr id="row_pptp_mru" style="display:none">
													...
													<td>
														<input type="text" maxlength="4" size="5" name="wan_pptp_mru"
															class="input" value="<% nvram_get_x(" ", "
															wan_pptp_mru "); %>"
															onkeypress="return is_number(this,event);" />
														&nbsp;
												...
												<tr id="row_l2tp_mtu" style="display:none">
													...
													<td>
														<input type="text" maxlength="4" size="5" name="wan_l2tp_mtu"
															class="input" value="<% nvram_get_x(" ", "
															wan_l2tp_mtu "); %>"
															onkeypress="return is_number(this,event);" />
														&nbsp;
												...
												<tr id="row_l2tp_mru" style="display:none">
													...
													<td>
														<input type="text" maxlength="4" size="5" name="wan_l2tp_mru"
															class="input" value="<% nvram_get_x(" ", "
															wan_l2tp_mru "); %>"
															onkeypress="return is_number(this,event);" />
														&nbsp;
												...
												<tr>
													...
													<td>
														<label class="radio inline">
															<input type="radio" value="1" name="wan_ppp_lcp"
																class="input" <% nvram_match_x( "" , "wan_ppp_lcp" , "1"
																, "checked" ); %>
															>
															<#checkbox_Yes#>
														</label>
														<label class="radio inline">
															<input type="radio" value="0" name="wan_ppp_lcp"
																class="input" <% nvram_match_x( "" , "wan_ppp_lcp" , "0"
																, "checked" ); %>
															>
															<#checkbox_No#>
														</label>
												...
												<tr>
													...
													<td>
														<label class="radio inline">
															<input type="radio" value="1" name="wan_ppp_alcp"
																class="input" <% nvram_match_x( "" , "wan_ppp_alcp"
																, "1" , "checked" ); %>
															>
															<#checkbox_Yes#>
														</label>
														<label class="radio inline">
															<input type="radio" value="0" name="wan_ppp_alcp"
																class="input" <% nvram_match_x( "" , "wan_ppp_alcp"
																, "0" , "checked" ); %>
															>
															<#checkbox_No#>
												...
												<tr id="row_pppoe_svc">
													<th>
														<a class="help_tooltip" href="javascript:void(0);"
															onmouseover="openTooltip(this,7,9);">
															<#PPPConnection_x_ServiceName_itemname#>
														</a>
													</th>
													<td>
														<input type="text" maxlength="32" class="input" size="32"
															name="wan_pppoe_service" value="<% nvram_get_x(" ","
															wan_pppoe_service "); %>"
															onkeypress="return is_string(this,event);" />
													</td>
												</tr>
												<tr id="row_pppoe_ac">
													<th>
														<a class="help_tooltip" href="javascript:void(0);"
															onmouseover="openTooltip(this,7,10);">
															<#PPPConnection_x_AccessConcentrator_itemname#>
														</a>
													</th>
													<td>
														<input type="text" maxlength="32" class="input" size="32"
															name="wan_pppoe_ac" value="<% nvram_get_x(" ","
															wan_pppoe_ac "); %>"
															onkeypress="return is_string(this,event);" />
													</td>
												</tr>
												<tr id="row_pppoe_it" style="display:none">
													<th>
														<a class="help_tooltip" href="javascript:void(0);"
															onmouseover="openTooltip(this,7,6);">
															<#PPPConnection_IdleDisconnectTime_itemname#>
														</a>
													</th>
													<td>
														<input type="text" maxlength="10" class="input" size="32"
															name="wan_pppoe_idletime" value="<% nvram_get_x(" ","
															wan_pppoe_idletime "); %>"
															onkeypress="return is_number(this,event);" />
														&nbsp;
														<span style="color:#888;">
												...
												<tr>
													<th>
														<a class="help_tooltip" href="javascript:void(0);"
															onmouseover="openTooltip(this,7,19);">
															<#PPPConnection_x_AdditionalOptions_itemname#>
														</a>
													</th>
													<td>
														<input type="text" name="wan_ppp_pppd"
															value="<% nvram_get_x(" ", " wan_ppp_pppd "); %>"
															class="input" maxlength="255" size="32"
															onKeyPress="return is_string(this,event);" />
													</td>
												</tr>
											</table>
											<table width="100%" cellpadding="4" cellspacing="0" class="table">
												...
												<tr id="row_auth_type">
													...
													<td>
														<select name="wan_auth_mode" class="input"
															onChange="AuthSelection(this.value)">
															<option value="0" <% nvram_match_x( "" , "wan_auth_mode"
																, "0" , "selected" ); %>
																>
																<#checkbox_No#>
															</option>
															<option value="1" <% nvram_match_x( "" , "wan_auth_mode"
																, "1" , "selected" ); %>
																>ISP KABiNET
															</option>
															<option value="2" <% nvram_match_x( "" , "wan_auth_mode"
																, "2" , "selected" ); %>
																>802.1x EAP-MD5
															</option>
															<option value="3" <% nvram_match_x( "" , "wan_auth_mode"
																, "3" , "selected" ); %>
																>802.1x EAP-TTLS/PAP
															</option>
															<option value="4" <% nvram_match_x( "" , "wan_auth_mode"
																, "4" , "selected" ); %>
																>802.1x EAP-TTLS/CHAP
															</option>
															<option value="5" <% nvram_match_x( "" , "wan_auth_mode"
																, "5" , "selected" ); %>
																>802.1x EAP-TTLS/MSCHAP
															</option>
															<option value="6" <% nvram_match_x( "" , "wan_auth_mode"
																, "6" , "selected" ); %>
																>802.1x EAP-TTLS/MSCHAPv2
															</option>
															<option value="7" <% nvram_match_x( "" , "wan_auth_mode"
																, "7" , "selected" ); %>
												...
												<tr id="row_auth_host">
													...
													<td>
														<input type="text" name="wan_auth_host" class="input"
															maxlength="15" size="32" value="<% nvram_get_x(" ","
															wan_auth_host "); %>"
															onKeyPress="return is_ipaddr(this,event);" />
													</td>
												</tr>
												<tr id="row_auth_user">
													...
													<td>
														<input type="text" maxlength="64" class="input" size="32"
															name="wan_auth_user" value="<% nvram_get_x(" ","
															wan_auth_user "); %>"
															onKeyPress="return is_string(this,event);" />
													</td>
												</tr>
												<tr id="row_auth_pass">
													...
													<td>
														<div class="input-append">
															<input type="password" maxlength="64" class="input"
																size="32" name="wan_auth_pass" id="wan_auth_pass"
																style="width: 175px;" value="<% nvram_get_x(" ","
																wan_auth_pass "); %>"
																onKeyPress="return is_string(this,event);" />
															<button style="margin-left: -5px;" class="btn" type="button"
																onclick="passwordShowHide('wan_auth_pass')">
																<i class="if if-btn-eyeclose">
																</i>
															</button>
														</div>
												...
												<tr id="row_hostname">
													<th>
														<a class="help_tooltip" href="javascript:void(0);"
															onmouseover="openTooltip(this,7,16);">
															<#PPPConnection_x_HostNameForISP_itemname#>
														</a>
													</th>
													<td>
														<input type="text" name="wan_hostname" class="input"
															maxlength="32" size="32" value="<% nvram_get_x(" ","
															wan_hostname "); %>"
															onkeypress="return is_string(this,event);" />
													</td>
												</tr>
												<tr id="row_vci">
													...
													<td>
														<input type="text" name="wan_vci" class="input" maxlength="128"
															size="32" value="<% nvram_get_x(" "," wan_vci "); %>"
															onkeypress="return is_string(this,event);" />
													</td>
												</tr>
												<tr>
													<th width="50%">
														<a class="help_tooltip" href="javascript:void(0);"
															onmouseover="openTooltip(this,7,17);">
															<#PPPConnection_x_MacAddressForISP_itemname#>
														</a>
													</th>
													<td>
														<input type="text" name="wan_hwaddr_x" class="input"
															style="float: left; margin-right: 5px;" maxlength="12"
															size="15" value="<% nvram_get_x(" "," wan_hwaddr_x "); %>"
															onKeyPress="return is_hwaddr(event);" />
												...
												<tr>
													...
													<td>
														<select name="wan_ttl_fix" class="input">
															<option value="0" <% nvram_match_x( "" , "wan_ttl_fix" , "0"
																, "selected" ); %>
																>
																<#WAN_TTL_Item0#>
																	(*)
															</option>
															<option value="1" <% nvram_match_x( "" , "wan_ttl_fix" , "1"
																, "selected" ); %>
																>
																<#WAN_TTL_Item1#>
															</option>
															<option value="2" <% nvram_match_x( "" , "wan_ttl_fix" , "2"
																, "selected" ); %>
																>
																<#WAN_TTL_Item2#>
															</option>
												...
												<tr>
													...
													<td>
														<select name="wan_ttl_value" class="input">
															<option value="0" <% nvram_match_x( "" , "wan_ttl_value"
																, "0" , "selected" ); %>
																>
																<#WAN_TTL_Value_Item0#>
																	(*)
															</option>
															<option value="64" <% nvram_match_x( "" , "wan_ttl_value"
																, "64" , "selected" ); %>
																>
																<#WAN_TTL_Value_Item1#>
															</option>
															<option value="128" <% nvram_match_x( "" , "wan_ttl_value"
																, "128" , "selected" ); %>
																>
																<#WAN_TTL_Value_Item2#>
															</option>
											...
											<table width="100%" align="center" cellpadding="4" cellspacing="0"
												class="table" id="tbl_viptv_sect" style="display:none">
												<tr>
													<th colspan="2" style="background-color: #E3E3E3;">
														<#MAN_VIPTV_desc#>
													</th>
												...
												<tr>
													...
													<td>
														<input type="text" name="viptv_ipaddr" maxlength="15"
															class="input" size="15" value="<% nvram_get_x(" ","
															viptv_ipaddr "); %>"
															onKeyPress="return is_ipaddr(this,event);" />
													</td>
												...
												<tr>
													...
													<td>
														<input type="text" name="viptv_netmask" maxlength="15"
															class="input" size="15" value="<% nvram_get_x(" ","
															viptv_netmask "); %>"
															onKeyPress="return is_ipaddr(this,event);" />
													</td>
												...
												<tr>
													...
													<td>
														<input type="text" name="viptv_gateway" maxlength="15"
															class="input" size="15" value="<% nvram_get_x(" ","
															viptv_gateway "); %>"
															onKeyPress="return is_ipaddr(this,event);" />
													</td>
											...
											<table width="100%" cellpadding="4" cellspacing="0" class="table">
												...
												<tr>
													<th>
														<a class="help_tooltip" href="javascript:void(0);"
															onmouseover="openTooltip(this,7,22);">
															<#Layer3Forwarding_x_STB_itemname#>
														</a>
													</th>
													<td>
														<select name="wan_stb_x" class="input"
															onChange="change_stb_port_and_vlan();">
															<option value="0" <% nvram_match_x( "" , "wan_stb_x" , "0"
																, "selected" ); %>
																>
																<#checkbox_No#>
															</option>
															<option value="1" <% nvram_match_x( "" , "wan_stb_x" , "1"
																, "selected" ); %>
																>LAN1
															</option>
															<option value="2" <% nvram_match_x( "" , "wan_stb_x" , "2"
																, "selected" ); %>
																>LAN2
															</option>
															<option value="3" <% nvram_match_x( "" , "wan_stb_x" , "3"
																, "selected" ); %>
																>LAN3
															</option>
															<option value="4" <% nvram_match_x( "" , "wan_stb_x" , "4"
																, "selected" ); %>
																>LAN4
															</option>
															<option value="5" <% nvram_match_x( "" , "wan_stb_x" , "5"
																, "selected" ); %>
																>LAN3 & LAN4
															</option>
															<option value="6" <% nvram_match_x( "" , "wan_stb_x" , "6"
																, "selected" ); %>
																>LAN1 & LAN2
															</option>
															<option value="7" <% nvram_match_x( "" , "wan_stb_x" , "7"
																, "selected" ); %>
																>LAN1 & LAN2 & LAN3
															</option>
														</select>
												...
												<tr id="wan_stb_iso">
													...
													<td>
														<select name="wan_stb_iso" class="input">
															<option value="0" <% nvram_match_x( "" , "wan_stb_iso" , "0"
																, "selected" ); %>
																>
																<#checkbox_No#>
															</option>
															<option value="1" <% nvram_match_x( "" , "wan_stb_iso" , "1"
																, "selected" ); %>
																>
																<#STB_IsolationItem1#>
															</option>
															<option value="2" <% nvram_match_x( "" , "wan_stb_iso" , "2"
																, "selected" ); %>
																>
																<#STB_IsolationItem2#>
															</option>
												...
												<tr>
													...
													<td>
														<input type="checkbox" id="vlan_filter_fake" <%
															nvram_match_x( "" , "vlan_filter" , "1" , "value=1 checked"
															); %>
														<% nvram_match_x( "" , "vlan_filter" , "0" , "value=0" ); %>
															>
															<div style="position: absolute; margin-left: -10000px;">
																<input type="radio" name="vlan_filter"
																	id="vlan_filter_1" value="1"
																	onClick="change_stb_port_and_vlan();" <%
																	nvram_match_x( "" , "vlan_filter" , "1" , "checked"
																	); %>
																/>
																<#checkbox_Yes#>
																	<input type="radio" name="vlan_filter"
																		id="vlan_filter_0" value="0"
																		onClick="change_stb_port_and_vlan();" <%
																		nvram_match_x( "" , "vlan_filter" , "0"
																		, "checked" ); %>
																	/>
																	<#checkbox_No#>
															</div>
												...
												<tr id="vlan_inet">
													...
													<td>
														<span class="input-prepend">
															...
															<input type="text" name="vlan_vid_cpu" class="wlan_filter"
																size="4" maxlength="4" value="<% nvram_get_x(" ", "
																vlan_vid_cpu "); %>"
																onkeypress="return is_number(this,event);"
														...
														<span class="input-prepend">
															...
															<input type="text" name="vlan_pri_cpu" class="wlan_filter"
																size="2" maxlength="1" value="<% nvram_get_x(" ", "
																vlan_pri_cpu "); %>"
																onkeypress="return is_number(this,event);" />
														</span>
													</td>
												...
												<tr id="vlan_iptv">
													...
													<td>
														<span class="input-prepend">
															...
															<input type="text" name="vlan_vid_iptv" class="wlan_filter"
																size="4" maxlength="4" value="<% nvram_get_x(" ", "
																vlan_vid_iptv "); %>"
																onkeypress="return is_number(this,event);"
																onblur="change_viptv_tag(1);" />
														...
														<span class="input-prepend">
															...
															<input type="text" name="vlan_pri_iptv" class="wlan_filter"
																size="2" maxlength="1" value="<% nvram_get_x(" ", "
																vlan_pri_iptv "); %>"
																onkeypress="return is_number(this,event);" />
														</span>
														<span class="input-prepend">
															&nbsp;
															<select name="viptv_mode" id="viptv_mode" class="input"
																style="width: 95px;" onchange="change_viptv_mode(1);">
																<option value="0" <% nvram_match_x( "" , "viptv_mode"
																	, "0" , "selected" ); %>
																	>DHCP (*)
																</option>
																<option value="1" <% nvram_match_x( "" , "viptv_mode"
																	, "1" , "selected" ); %>
																	>ZeroConf
																</option>
																<option value="2" <% nvram_match_x( "" , "viptv_mode"
																	, "2" , "selected" ); %>
																	>Static IP
																</option>
															</select>
												...
												<tr id="vlan_lan1">
													...
													<td>
														<span class="input-prepend">
															...
															<input type="text" name="vlan_vid_lan1" class="wlan_filter"
																size="4" maxlength="4" value="<% nvram_get_x(" ", "
																vlan_vid_lan1 "); %>"
																onkeypress="return is_number(this,event);" />
															&nbsp;&nbsp;
														...
														<span class="input-prepend">
															...
															<input type="text" name="vlan_pri_lan1" class="wlan_filter"
																size="2" maxlength="1" value="<% nvram_get_x(" ", "
																vlan_pri_lan1 "); %>"
																onkeypress="return is_number(this,event);" />
															&nbsp;&nbsp;
														...
														<label class="checkbox inline">
															<input type="checkbox" name="untag_lan1" value=""
												...
												<tr id="vlan_lan2">
													...
													<td>
														<span class="input-prepend">
															...
															<input type="text" name="vlan_vid_lan2" class="wlan_filter"
																size="4" maxlength="4" value="<% nvram_get_x(" ", "
																vlan_vid_lan2 "); %>"
																onkeypress="return is_number(this,event);" />
															&nbsp;&nbsp;
														...
														<span class="input-prepend">
															...
															<input type="text" name="vlan_pri_lan2" class="wlan_filter"
																size="2" maxlength="1" value="<% nvram_get_x(" ", "
																vlan_pri_lan2 "); %>"
																onkeypress="return is_number(this,event);" />
															&nbsp;&nbsp;
														...
														<label class="checkbox inline">
															<input type="checkbox" name="untag_lan2" value=""
																style="margin-left:10;"
												...
												<tr id="vlan_lan3">
													...
													<td>
														<span class="input-prepend">
															...
															<input type="text" name="vlan_vid_lan3" class="wlan_filter"
																size="4" maxlength="4" value="<% nvram_get_x(" ", "
																vlan_vid_lan3 "); %>"
																onkeypress="return is_number(this,event);" />
															&nbsp;&nbsp;
														...
														<span class="input-prepend">
															...
															<input type="text" name="vlan_pri_lan3" class="wlan_filter"
																size="2" maxlength="1" value="<% nvram_get_x(" ", "
																vlan_pri_lan3 "); %>"
																onkeypress="return is_number(this,event);" />
															&nbsp;&nbsp;
														...
														<label class="checkbox inline">
															<input type="checkbox" name="untag_lan3" value=""
																style="margin-left:10;"
												...
												<tr id="vlan_lan4">
													...
													<td>
														<span class="input-prepend">
															...
															<input type="text" name="vlan_vid_lan4" class="wlan_filter"
																size="4" maxlength="4" value="<% nvram_get_x(" ", "
																vlan_vid_lan4 "); %>"
																onkeypress="return is_number(this,event);" />
															&nbsp;&nbsp;
														...
														<span class="input-prepend">
															...
															<input type="text" name="vlan_pri_lan4" class="wlan_filter"
																size="2" maxlength="1" value="<% nvram_get_x(" ", "
																vlan_pri_lan4 "); %>"
																onkeypress="return is_number(this,event);" />
															&nbsp;&nbsp;
														...
														<label class="checkbox inline">
															<input type="checkbox" name="untag_lan4" value=""
																style="margin-left:10;"
													...
													<td style="border: 0 none;">
														<center>
															<input name="button" type="button" class="btn btn-primary"
																style="width: 219px" onclick="applyRule();"
																value="<#CTL_apply#>" />
														</center>
													</td>
												</tr>
